...
import 'package:basic/widgets/home_widgets/catalog_header.dart';
import 'package:basic/widgets/home_widgets/catalog_list.dart';
    ...
    return Scaffold(
        ...
        floatingActionButton: VxBuilder(
          ...
          builder: (ctx, dynamic, _) => FloatingActionButton(
            ...
            backgroundColor: Theme.of(context).buttonTheme as Color?,
            child: Icon(
              CupertinoIcons.cart,
              color: Colors.white,
            ),
